...
public class MyHttpServer {
	...
	public static String WEB_ROOT = "/Users/lxiong1/ebay/code/algorithm/src/main/resources";
	//port
	private int port;
	//用户请求的文件的url
	...
	public static void main(String args[]) throws Exception {
		MyHttpServer server = new MyHttpServer("/Users/lxiong1/ebay/code/algorithm/src/main/resources", 8080);
		server.service();
	}
}